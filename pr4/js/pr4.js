...
var tasklist = ['Здесь полный список задач, введите соответствующие к ним значения, чтобы запустить задачи...\n\n',
    ...
    'Задача 14 - \n',
    'Задача 15 - Ввод задач пользователем:         14\n'
];
...
if (task == 1) {
    ...
    console.log("Вывела 10 раз число 10 потому что не указали время в функцию задержки врменеи. И в этом случае функция сработала таким образом, чтобы вывести результат как можно быстро, не задерживая время...");
    setTimeout(function() {
